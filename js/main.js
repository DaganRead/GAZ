...
/*                    var month = element.slaughterDate.substring(4,7),
        ...
        search : {
            sales : function(target) {
                ...
                if (name) {
                    var filteredSales = this.data.sales.filter(filterOption(element.name.formatted, searchTerm));
                }else if (location) {
                    var filteredSales = this.data.sales.filter(filterOption(element.location.location, searchTerm));
                }else if (date) {
                    var filteredSales = this.data.sales.filter(filterOption(element.slaughterDate, searchTerm));
                };
                ...
                filteredSales.sort(function(a,b) { 
                    ...
                    filteredSales.forEach(function(innerElement, innerIndex, innerArray) {
                                HTMLFrag +='<fieldset data-index="';
                                HTMLFrag += innerIndex;
                                HTMLFrag += '"><legend>&nbsp;';
                                HTMLFrag += innerElement.slaughterDate;
