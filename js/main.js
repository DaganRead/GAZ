        ...
        binding : {
            ...
            customers : function() {
                    ...
                    this.data.customers.forEach(function(element, index, array) {
                            ...
                            this.DOM.customers.innerHTML = HTMLFrag;
                    });
            },
            items : function() {      
                    var HTMLFrag = '', 
                    ...
                    this.DOM.items.innerHTML = HTMLFrag;
            },
            slaughters : function(changes) {
                        ...
                        var newChar,
                            ...
                            numbersStarted = false;
                        //refresh with this data;
                        this.data.slaughters.forEach(function(innerElement, innerIndex, innerArray) {
                        ...
                        this.DOM.slaughters.innerHTML = HTMLFrag;
            },
